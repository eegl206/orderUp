    ...
    render() {
        return (
            <div className="menu-item collection-item">
                <span className="menu-item-label">Food</span>

                <span className="new badge green valign-wrapper" data-badge-caption=""><i className="menu-item-icon material-icons">timer</i>&nbsp;~6min</span>
